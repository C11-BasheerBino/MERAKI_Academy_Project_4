...
const getAllProvidersByAdmin = (req, res) => {
  providerModel
    .find()
    .then((result) => {
      const keys = {
...
const updateProviderStatus = (req, res) => {
...
module.exports = { registerProvider, loginProvider, getAllProvidersByAdmin,updateProviderStatus };
